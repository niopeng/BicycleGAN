    ...
    def __init__(self, opt):
        ...
        if opt.isTrain:
            ...
            if use_D:
                ...
                self.optimizer_D = torch.optim.Adam(self.netD.parameters(), lr=opt.lr * 5, betas=(opt.beta1, 0.999))
            ...
            if use_D2:
                ...
                self.optimizer_D2 = torch.optim.Adam(self.netD2.parameters(), lr=opt.lr * 5, betas=(opt.beta1, 0.999))
